...
urlpatterns = [
    ...
    path('<int:pk>/started/<int:question_id>/remove/image', views.QuizAnswerRemoveImage.as_view(), name='quiz-remove-answer-image'),
    path('<int:pk>/started/<int:question_id>/remove/pdf', views.QuizAnswerRemovePDF.as_view(), name='quiz-remove-answer-file'),
